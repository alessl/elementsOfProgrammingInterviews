 ...
 */
public class _167_BedBathAndBeyond_TODO {

    public static void main(String[] args) {
        String text = "googlefacebookamazonjob";
        Set<String> dict = new HashSet<>(Arrays.asList("google", "amazon", "facebook", "job"));
        System.out.println(getWords(text, dict));
    }

    private static List<String> getWords(String text, Set<String> dict) {
