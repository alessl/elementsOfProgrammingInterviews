 ...
 */
public class _2411_LongestSubStrWithMatchingParens_TODO {

    public static void main(String[] args) {
        printLongestValidSubStr("(()((())((())()");
        printLongestValidSubStr("(())()");
        printLongestValidSubStr("(()))()");
    }

    private static void printLongestValidSubStr(String str) {
        System.out.printf("String: %s, max valid substring:%s%n", str, getLongestValidSubStr(str));
    }

    private static String getLongestValidSubStr(String s) {
        var maxValidStart = 0;
        var maxValidLen = 0;
